...
export class DashboardComponent implements OnInit {
  //id:number = this.dataService.getId();
  players:ProTennisPlayer[];
  constructor(private dataService: TennisDataService) { 
    dataService.players$.subscribe( playrs =>
      {this.players = playrs;}
  );
}

get player() : ProTennisPlayer
{
  ...
  for(let playrs of this.players)
  {
     if(playrs.id == this.dataService.getId())
       return Object.assign({}, playrs);
  }
}
